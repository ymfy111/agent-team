...
- `docs/tasks/TF-GF-IMPL-v0.6.33.45.md`：作为 GF-IMPL 工作包 / TaskFlowGroup，维护 01/02/03/04 的状态、产物、Run 和 Report。
- `docs/tasks/TF-GUARDED-FLOW-NEXT-v0.6.33.45.md`：保留为历史后续建议入口，当前状态以 `TF-GF-IMPL` 工作包主文档为准。
