...
| Stage / Plan | 阶段计划、路线图 | `docs/plans/`、`docs/tasks/*ROADMAP*` |
| TaskFlow | `TF-DOC-STRUCT`、`TF-POC-MD`、`TF-GF-IMPL-*` | 结构化 Markdown 任务流 |
...
- `DEV-TASKFLOW-NEXT-v0.6.33.45.md`：保留为 TF-GOV-02 阶段建议与历史任务入口，后续当前状态以本文和 Guarded Flow 路线图为准。
- `TF-GUARDED-FLOW-ROADMAP-v0.6.33.45.md`：作为 Guarded Flow 子路线图，记录 GF-IMPL 系列已完成项、下一项和命令能力。
- `TF-GUARDED-FLOW-NEXT-v0.6.33.45.md`：作为 GF-IMPL 最小实现建议清单，后续应逐步同步状态。
- `SDD-TASKFLOW-TASKTICKET-MODEL-v0.6.33.md`：作为 TaskFlow / TaskTicket 产品对象子设计。
