...
- 当前系统设计：`docs/specs/2026-05-13-智能软件工厂系统设计方案-v0.6.32-revised.md`
- agent-web-kit 集成方案：`docs/specs/2026-05-14-智能软件工厂-agent-web-kit集成方案-v0.6.32.md`
- 当前原型：`docs/prototypes/Agent-Team-V2-注册中心-v0.6.32-p0a-flow.html`
- 原型基线参考：`docs/prototypes/Agent-Team-V2-注册中心-v0.6.32-ui-review-task-breakdown.html`
...
3. 跑通 P0a 最小闭环：`Skill → AgentTemplate → Worker → Team/Project → Doc 发布 → Decision 处理 → Activity 回写`。
4. 以 `v0.6.32-p0a-flow` 原型作为闭环演示参照，验证普通员工通过 Leader 联系、Skill 发布、模板挂载技能、创建数字员工、文档发布、决策处理与 Activity 回写。
